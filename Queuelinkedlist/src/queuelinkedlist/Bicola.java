...
// Es necesario recorrer la bicola para situarse en Il el nodo anterior al final, para después enlazar. 
    ...
    public Object quitarFinal() throws Exception {
        ...
        if (!ColaVacia()) {
            if (frente == fin) // la Bicola dispone de un solo nodo 
            {
                ...
                // siguiente del nodo anterior se pone a null a.siguiente = null;
                a.siguiente = null;
                aux = fin.elemento;
                fin = a;
            }
